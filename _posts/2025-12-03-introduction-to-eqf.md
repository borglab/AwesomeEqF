...
Following our [previous post on IEKF](/AwesomeEqF/blog/2025/12/03/understanding-iekf/), let's explore the Equivariant Filter (EqF)—a powerful generalization that takes invariant filtering to the next level.
